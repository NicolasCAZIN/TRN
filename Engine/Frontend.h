...
namespace TRN
{
	namespace Engine
	{
		...
		public:
			...
			void install_ack(const std::function<void(const unsigned long long &simulation_id, const std::size_t &counter, const bool &success, const std::string &cause)> &functor);
			...
			void install_allocated(const std::function<void(const unsigned long long &simulation_id, const int &rank)> &functor);
			void install_deallocated(const std::function<void(const unsigned long long &simulation_id, const int &rank)> &functor);
			void install_quit(const std::function<void(const int &rank)> &functor);
			void install_trained(const std::function<void(const unsigned long long &simulation_id, const unsigned long long &evaluation_id)> &functor);
			void install_configured(const std::function<void(const unsigned long long &simulation_id)> &functor);
			void install_primed(const std::function<void(const unsigned long long &simulation_id, const unsigned long long &evaluation_id)> &functor);
			void install_tested(const std::function<void(const unsigned long long &simulation_id, const unsigned long long &evaluation_id)> &functor);
			...
			void install_measurement_readout_mean_square_error(const unsigned long long &simulation_id, const std::function<void(const unsigned long long &simulation_id, const unsigned long long &evaluation_id, const std::vector<float> &values, const std::size_t &rows, const  std::size_t &cols)> &functor);
			void install_measurement_readout_frechet_distance(const unsigned long long &simulation_id, const std::function<void(const unsigned long long &simulation_id, const unsigned long long &evaluation_id, const std::vector<float> &values, const std::size_t &rows, const  std::size_t &cols)> &functor);
			...
			void install_measurement_position_mean_square_error(const unsigned long long &simulation_id, const std::function<void(const unsigned long long &simulation_id, const unsigned long long &evaluation_id, const std::vector<float> &values, const std::size_t &rows, const  std::size_t &cols)> &functor);
			void install_measurement_position_frechet_distance(const unsigned long long &simulation_id, const std::function<void(const unsigned long long &simulation_id, const unsigned long long &evaluation_id, const std::vector<float> &values, const std::size_t &rows, const  std::size_t &cols)> &functor);
			void install_measurement_position_custom(const unsigned long long &simulation_id, const std::function<void(const unsigned long long &simulation_id, const unsigned long long &evaluation_id, const std::vector<float> &primed, const std::vector<float> &predicted, const std::vector<float> &expected, const std::size_t &preamble, const std::size_t &pages, const std::size_t &rows, const  std::size_t &cols)> &functor);

			void install_performances(const unsigned long long &simulation_id, const std::function<void(const unsigned long long &simulation_id, const unsigned long long &evaluation_id, const std::string &phase, const float &cycles_per_second, const float &gflops_per_second)> &functor);
			void install_states(const unsigned long long &simulation_id, const std::function<void(const unsigned long long &simulation_id, const unsigned long long &evaluation_id, const std::string &phase, const std::string &label, const std::size_t &batch, const std::vector<float> &samples, const std::size_t &rows, const std::size_t &cols)> &functor);
			void install_weights(const unsigned long long &simulation_id, const std::function<void(const unsigned long long &simulation_id, const unsigned long long &evaluation_id, const std::string &phase, const std::string &label, const std::size_t &batch,const std::vector<float> &samples, const std::size_t &rows, const std::size_t &cols)> &functor);
			void install_position(const unsigned long long &simulation_id, const std::function<void(const unsigned long long &simulation_id, const unsigned long long &evaluation_id, const std::vector<float> &position, const std::size_t &rows, const std::size_t &cols)> &functor);
			void install_stimulus(const unsigned long long &simulation_id, const std::function<void(const unsigned long long &simulation_id, const unsigned long long &evaluation_id, const std::vector<float> &stimulus, const std::size_t &rows, const std::size_t &cols)> &functor);

			void install_mutator(const unsigned long long &simulation_id, const std::function<void(const unsigned long long &simulation_id, const unsigned long long &evaluation_id, const unsigned long &seed,  const std::vector<int> &offsets, const std::vector<int> &durations)> &functor);
			...
			void install_scheduling(const unsigned long long &simulation_id, const std::function<void(const unsigned long long &simulation_id, const std::size_t &trial, const std::vector<int> &offsets, const std::vector<int> &durations)> &functor);

			void install_feedforward(const unsigned long long &simulation_id, const std::function<void(const unsigned long long &simulation_id, const unsigned long &seed, const std::size_t &matrices, const std::size_t &rows, const  std::size_t &cols)> &functor);
			void install_feedback(const unsigned long long &simulation_id, const std::function<void(const unsigned long long &simulation_id, const unsigned long &seed, const std::size_t &matrices, const std::size_t &rows, const  std::size_t &cols)> &functor);
			void install_readout(const unsigned long long &simulation_id, const std::function<void(const unsigned long long &simulation_id, const unsigned long &seed, const std::size_t &matrices, const std::size_t &rows, const  std::size_t &cols)> &functor);
			void install_recurrent(const unsigned long long &simulation_id, const std::function<void(const unsigned long long &simulation_id, const unsigned long &seed, const std::size_t &matrices, const std::size_t &rows, const std::size_t &cols)> &functor);
		...
		protected:
			...
			virtual void callback_feedback(const unsigned long long &simulation_id, const unsigned long &seed, const std::size_t &matrices, const std::size_t &rows, const  std::size_t &cols) override;
		...
		public:
			static std::shared_ptr<Frontend> create(const std::shared_ptr<TRN::Engine::Communicator> &communicator);
		};
	};
};