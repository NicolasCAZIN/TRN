...
namespace TRN
{
	namespace Engine
	{
		...
		public:
			...
			void install_trained(const std::function<void(const unsigned long long &id)> &functor);
			void install_configured(const std::function<void(const unsigned long long &id)> &functor);
			void install_primed(const std::function<void(const unsigned long long &id)> &functor);
			void install_tested(const std::function<void(const unsigned long long &id)> &functor);
			...
			void install_measurement_readout_mean_square_error(const unsigned long long &id, const std::function<void(const unsigned long long &id, const std::size_t &trial, const std::size_t &evaluation, const std::vector<float> &values, const std::size_t &rows, const  std::size_t &cols)> &functor);
			void install_measurement_readout_frechet_distance(const unsigned long long &id, const std::function<void(const unsigned long long &id, const std::size_t &trial, const std::size_t &evaluation, const std::vector<float> &values, const std::size_t &rows, const  std::size_t &cols)> &functor);
			...
			void install_measurement_position_mean_square_error(const unsigned long long &id, const std::function<void(const unsigned long long &id, const std::size_t &trial, const std::size_t &evaluation, const std::vector<float> &values, const std::size_t &rows, const  std::size_t &cols)> &functor);
			void install_measurement_position_frechet_distance(const unsigned long long &id, const std::function<void(const unsigned long long &id, const std::size_t &trial, const std::size_t &evaluation, const std::vector<float> &values, const std::size_t &rows, const  std::size_t &cols)> &functor);
			void install_measurement_position_custom(const unsigned long long &id, const std::function<void(const unsigned long long &id, const std::size_t &trial, const std::size_t &evaluation, const std::vector<float> &primed, const std::vector<float> &predicted, const std::vector<float> &expected, const std::size_t &preamble, const std::size_t &pages, const std::size_t &rows, const  std::size_t &cols)> &functor);

			void install_performances(const unsigned long long &id, const std::function<void(const unsigned long long &id, const std::size_t &trial, const std::size_t &evaluation, const std::string &phase, const float &cycles_per_second, const float &gflops_per_second)> &functor);
			void install_states(const unsigned long long &id, const std::function<void(const unsigned long long &id, const std::string &phase, const std::string &label, const std::size_t &batch, const std::size_t &trial, const std::size_t &evaluation, const std::vector<float> &samples, const std::size_t &rows, const std::size_t &cols)> &functor);
			void install_weights(const unsigned long long &id, const std::function<void(const unsigned long long &id, const std::string &phase, const std::string &label, const std::size_t &batch, const std::size_t &trial, const std::vector<float> &samples, const std::size_t &rows, const std::size_t &cols)> &functor);
			void install_position(const unsigned long long &id, const std::function<void(const unsigned long long &id, const std::size_t &trial, const std::size_t &evaluation, const std::vector<float> &position, const std::size_t &rows, const std::size_t &cols)> &functor);
			void install_stimulus(const unsigned long long &id, const std::function<void(const unsigned long long &id, const std::size_t &trial, const std::size_t &evaluation, const std::vector<float> &stimulus, const std::size_t &rows, const std::size_t &cols)> &functor);

			void install_mutator(const unsigned long long &id, const std::function<void(const unsigned long long &id, const unsigned long &seed, const std::size_t &trial, const std::vector<int> &offsets, const std::vector<int> &durations)> &functor);
			void install_scheduler(const unsigned long long &id, const std::function<void(const unsigned long long &id, const unsigned long &seed, const std::size_t &trial, const std::vector<float> &elements, const std::size_t &rows, const std::size_t &cols, const std::vector<int> &offsets, const std::vector<int> &durations)> &functor);
			void install_scheduling(const unsigned long long &id, const std::function<void(const unsigned long long &id, const std::size_t &trial, const std::vector<int> &offsets, const std::vector<int> &durations)> &functor);

			void install_feedforward(const unsigned long long &id, const std::function<void(const unsigned long long &id, const unsigned long &seed, const std::size_t &matrices, const std::size_t &rows, const  std::size_t &cols)> &functor);
			void install_feedback(const unsigned long long &id, const std::function<void(const unsigned long long &id, const unsigned long &seed, const std::size_t &matrices, const std::size_t &rows, const  std::size_t &cols)> &functor);
			void install_readout(const unsigned long long &id, const std::function<void(const unsigned long long &id, const unsigned long &seed, const std::size_t &matrices, const std::size_t &rows, const  std::size_t &cols)> &functor);
			void install_recurrent(const unsigned long long &id, const std::function<void(const unsigned long long &id, const unsigned long &seed, const std::size_t &matrices, const std::size_t &rows, const std::size_t &cols)> &functor);
