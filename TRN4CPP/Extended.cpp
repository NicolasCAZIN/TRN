...
extern std::function<void(const unsigned long long &id, const std::size_t &trial, const std::size_t &evaluation, const std::vector<float> &position, const std::size_t &rows, const std::size_t &cols)> reply_position;
extern std::function<void(const unsigned long long &id, const std::size_t &trial, const std::size_t &evaluation, const std::vector<float> &position, const std::size_t &rows, const std::size_t &cols)> reply_stimulus;
extern std::function<void(const unsigned long long &id, const std::size_t &trial, const std::vector<int> &offsets, const std::vector<int> &durations)> reply_scheduler;
extern std::function<void(const unsigned long long &id, const std::size_t &trial, const std::vector<int> &offsets, const std::vector<int> &durations)> reply_mutator;
extern std::function<void(const unsigned long long &id, const std::vector<float> &weights, const std::size_t &matrices, const std::size_t &rows, const std::size_t &cols)> reply_feedforward;
extern std::function<void(const unsigned long long &id, const std::vector<float> &weights, const std::size_t &matrices, const std::size_t &rows, const std::size_t &cols)> reply_feedback;
extern std::function<void(const unsigned long long &id, const std::vector<float> &weights, const std::size_t &matrices, const std::size_t &rows, const std::size_t &cols)> reply_recurrent;
extern std::function<void(const unsigned long long &id, const std::vector<float> &weights, const std::size_t &matrices, const std::size_t &rows, const std::size_t &cols)> reply_readout;
...
void TRN4CPP::Simulation::deallocate(const unsigned long long &id)
{
	TRACE_LOGGER;
	if (!frontend)
		throw std::runtime_error("Frontend is not initialized");
...
void TRN4CPP::Simulation::declare_set(const unsigned long long &id, const std::string &label, const std::string &tag, const std::vector<std::string> &labels)
{
	TRACE_LOGGER;
	if (!frontend)
		throw std::runtime_error("Frontend is not initialized");
...
void TRN4CPP::Simulation::configure_begin(const unsigned long long &id)
{
	TRACE_LOGGER;
	if (!frontend)
		throw std::runtime_error("Frontend is not initialized");
...
void TRN4CPP::Simulation::configure_end(const unsigned long long &id)
{
	TRACE_LOGGER;
	if (!frontend)
		throw std::runtime_error("Frontend is not initialized");
...
void TRN4CPP::Simulation::Recording::States::configure(const unsigned long long &id, const bool &train, const bool &prime, const bool &generate)
{
	TRACE_LOGGER;
	if (!on_states)
		throw std::runtime_error("States callback is not installed");
	TRN4CPP::Simulation::Recording::States::configure(id, on_states, train, prime, generate);
}
void TRN4CPP::Simulation::Recording::Weights::configure(const unsigned long long &id, const bool &initialize, const bool &train)
{
	TRACE_LOGGER;
	if (!on_weights)
		throw std::runtime_error("States callback is not installed");
	TRN4CPP::Simulation::Recording::Weights::configure(id, on_weights, initialize, train);
}
void TRN4CPP::Simulation::Recording::Performances::configure(const unsigned long long &id, const bool &train, const bool &prime, const bool &generate)
{
	TRACE_LOGGER;
	if (!on_states)
		throw std::runtime_error("States callback is not installed");
	TRN4CPP::Simulation::Recording::Performances::configure(id, on_performances, train, prime, generate);
}
void TRN4CPP::Simulation::Recording::Scheduling::configure(const unsigned long long &id)
{
	TRACE_LOGGER;
	if (!on_states)
		throw std::runtime_error("States callback is not installed");
	TRN4CPP::Simulation::Recording::Scheduling::configure(id, on_scheduling);
}
void TRN4CPP::Simulation::Measurement::Readout::MeanSquareError::configure(const unsigned long long &id, const std::size_t &batch_size)
{
	TRACE_LOGGER;
	...
	TRN4CPP::Simulation::Measurement::Readout::MeanSquareError::configure(id, batch_size, on_measurement_readout_mean_square_error);
}
void TRN4CPP::Simulation::Measurement::Readout::FrechetDistance::configure(const unsigned long long &id, const std::size_t &batch_size)
{
	TRACE_LOGGER;
	...
	TRN4CPP::Simulation::Measurement::Readout::FrechetDistance::configure(id, batch_size, on_measurement_readout_frechet_distance);
}
void TRN4CPP::Simulation::Measurement::Readout::Custom::configure(const unsigned long long &id, const std::size_t &batch_size)
{
	TRACE_LOGGER;
	if (!on_measurement_readout_raw)
		throw std::runtime_error("Measurement readout raw callback is not installed");
	TRN4CPP::Simulation::Measurement::Readout::Custom::configure(id, batch_size, on_measurement_readout_raw);
}
void TRN4CPP::Simulation::Measurement::Position::MeanSquareError::configure(const unsigned long long &id, const std::size_t &batch_size)
{
	TRACE_LOGGER;
	...
	TRN4CPP::Simulation::Measurement::Position::MeanSquareError::configure(id, batch_size, on_measurement_position_mean_square_error);
}
void TRN4CPP::Simulation::Measurement::Position::FrechetDistance::configure(const unsigned long long &id, const std::size_t &batch_size)
{
	TRACE_LOGGER;
	...
	TRN4CPP::Simulation::Measurement::Position::FrechetDistance::configure(id, batch_size, on_measurement_position_frechet_distance);
}
void TRN4CPP::Simulation::Measurement::Position::Custom::configure(const unsigned long long &id, const std::size_t &batch_size)
{
	TRACE_LOGGER;
	if (!on_measurement_position_raw)
		throw std::runtime_error("Measurement position raw callback is not installed");
	TRN4CPP::Simulation::Measurement::Position::Custom::configure(id, batch_size, on_measurement_position_raw);
}
void TRN4CPP::Simulation::Reservoir::WidrowHoff::configure(const unsigned long long &id, const std::size_t &stimulus_size, const std::size_t &prediction_size, const std::size_t &reservoir_size, const float &leak_rate, const float &initial_state_scale, const float &learning_rate, const unsigned long &seed, const std::size_t &batch_size)
{
	TRACE_LOGGER;
	if (!frontend)
		throw std::runtime_error("Frontend is not initialized");
...
void TRN4CPP::Simulation::Loop::Copy::configure(const unsigned long long &id, const std::size_t &batch_size, const std::size_t &stimulus_size)
{
	TRACE_LOGGER;
	if (!frontend)
		throw std::runtime_error("Frontend is not initialized");
...
void TRN4CPP::Simulation::Loop::SpatialFilter::configure(const unsigned long long &id, const std::size_t &batch_size, const std::size_t &stimulus_size, const unsigned long &seed,
...
)
{
	...
	TRN4CPP::Simulation::Loop::SpatialFilter::configure(id, batch_size, stimulus_size, seed, on_position, reply_position, on_stimulus, reply_stimulus, rows, cols, x, y, response, sigma, radius, scale, tag);
...
void TRN4CPP::Simulation::Loop::Custom::configure(const unsigned long long &id, const std::size_t &batch_size, const std::size_t &stimulus_size)
{
	TRACE_LOGGER;
	if (!on_stimulus)
		throw std::runtime_error("Stimulus callback is not installed");
	if (!reply_stimulus)
		throw std::runtime_error("Stimulus reply functor is not installed");
	auto old_reply_stimulus = reply_stimulus;
	TRN4CPP::Simulation::Loop::Custom::configure(id, batch_size, stimulus_size, on_stimulus, reply_stimulus);
	if (old_reply_stimulus != reply_stimulus)
		throw std::runtime_error("Stimulus reply functor changed");
}
void TRN4CPP::Simulation::Scheduler::Tiled::configure(const unsigned long long &id, const unsigned int &epochs)
{
	TRACE_LOGGER;
	if (!frontend)
		throw std::runtime_error("Frontend is not initialized");
...
void TRN4CPP::Simulation::Scheduler::Snippets::configure(const unsigned long long &id, const unsigned long &seed, const unsigned int &snippets_size, const unsigned int &time_budget, const std::string &tag)
{
	TRACE_LOGGER;
	if (!frontend)
		throw std::runtime_error("Frontend is not initialized");
...
void TRN4CPP::Simulation::Scheduler::Custom::configure(const unsigned long long &id, const unsigned long &seed,const std::string &tag)
{
	TRACE_LOGGER;
	if (!on_scheduler)
	...
	TRN4CPP::Simulation::Scheduler::Custom::configure(id, seed, on_scheduler, reply_scheduler, tag);
	if (old_scheduler != reply_scheduler)
		throw std::runtime_error("Scheduler reply functor changed");
}
void TRN4CPP::Simulation::Scheduler::Mutator::Shuffle::configure(const unsigned long long &id, const unsigned long &seed)
{
	TRACE_LOGGER;
	if (!frontend)
		throw std::runtime_error("Frontend is not initialized");
...
void TRN4CPP::Simulation::Scheduler::Mutator::Reverse::configure(const unsigned long long &id, const unsigned long &seed, const float &rate, const std::size_t &size)
{
	TRACE_LOGGER;
	if (!frontend)
		throw std::runtime_error("Frontend is not initialized");
...
void TRN4CPP::Simulation::Scheduler::Mutator::Custom::configure(const unsigned long long &id, const unsigned long &seed)
{
	...
	TRN4CPP::Simulation::Scheduler::Mutator::Custom::configure(id, seed, on_mutator, reply_mutator);
	if (old_mutator != reply_mutator)
		throw std::runtime_error("Mutator reply functor changed");
}
void TRN4CPP::Simulation::Reservoir::Weights::Readout::Uniform::configure(const unsigned long long &id, const float &a, const float &b, const float &sparsity)
{
	TRACE_LOGGER;
	if (!frontend)
		throw std::runtime_error("Frontend is not initialized");
...
void TRN4CPP::Simulation::Reservoir::Weights::Readout::Custom::configure(const unsigned long long &id)
{
	...
	TRN4CPP::Simulation::Reservoir::Weights::Readout::Custom::configure(id, on_readout, reply_readout);
	if (old_readout != reply_readout)
		throw std::runtime_error("Readout reply functor changed");
}
void TRN4CPP::Simulation::Reservoir::Weights::Feedback::Uniform::configure(const unsigned long long &id, const float &a, const float &b, const float &sparsity)
{
	TRACE_LOGGER;
	if (!frontend)
		throw std::runtime_error("Frontend is not initialized");
...
void TRN4CPP::Simulation::Reservoir::Weights::Feedback::Custom::configure(const unsigned long long &id)
{
	...
	TRN4CPP::Simulation::Reservoir::Weights::Feedback::Custom::configure(id, on_feedback, reply_feedback);
	if (old_feedback != reply_feedback)
		throw std::runtime_error("Feedback reply functor changed");
}
void TRN4CPP::Simulation::Reservoir::Weights::Recurrent::Uniform::configure(const unsigned long long &id, const float &a, const float &b, const float &sparsity)
{
	TRACE_LOGGER;
	if (!frontend)
		throw std::runtime_error("Frontend is not initialized");
...
void TRN4CPP::Simulation::Reservoir::Weights::Recurrent::Custom::configure(const unsigned long long &id)
{
	...
	TRN4CPP::Simulation::Reservoir::Weights::Recurrent::Custom::configure(id, on_recurrent, reply_recurrent);
	if (old_recurrent != reply_recurrent)
		throw std::runtime_error("Recurrent reply functor changed");
}
void TRN4CPP::Simulation::Reservoir::Weights::Feedforward::Uniform::configure(const unsigned long long &id, const float &a, const float &b, const float &sparsity)
{
	TRACE_LOGGER;
	if (!frontend)
		throw std::runtime_error("Frontend is not initialized");
...
void TRN4CPP::Simulation::Reservoir::Weights::Feedforward::Custom::configure(const unsigned long long &id)
{
	...
	TRN4CPP::Simulation::Reservoir::Weights::Feedforward::Custom::configure(id, on_feedforward, reply_feedforward);
