...
namespace TRN4CPP
{
	...
	void TRN4CPP_EXPORT  	test(const unsigned int &id, const std::string &sequence,const std::string &incoming, const std::string &expected, const unsigned int &preamble);
	...
	void TRN4CPP_EXPORT  	configure_readout_custom(const unsigned int &id,
		const std::function<void(const unsigned int &id, const std::size_t &matrices, const std::size_t &rows, const std::size_t &cols)> &request,
	...
	void TRN4CPP_EXPORT  	configure_feedback_custom(const unsigned int &id, const std::function<void(const unsigned int &id, const std::size_t &matrices, const std::size_t &rows, const std::size_t &cols)> &request,
		std::function<void(const unsigned int &id, const std::vector<float> &weights, const std::size_t &matrices, const std::size_t &rows, const std::size_t &cols)> &reply);
	...
	void TRN4CPP_EXPORT  	configure_recurrent_custom(const unsigned int &id, const std::function<void(const unsigned int &id, const std::size_t &matrices, const std::size_t &rows, const std::size_t &cols)> &request,
		std::function<void(const unsigned int &id, const std::vector<float> &weights, const std::size_t &matrices, const std::size_t &rows, const std::size_t &cols)> &reply);
	...
	void TRN4CPP_EXPORT  	configure_feedforward_custom(const unsigned int &id, const std::function<void(const unsigned int &id, const std::size_t &matrices, const std::size_t &rows, const std::size_t &cols)> &request,
		std::function<void(const unsigned int &id, const std::vector<float> &weights, const std::size_t &matrices, const std::size_t &rows, const std::size_t &cols)> &reply);
};
