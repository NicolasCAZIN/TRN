...
namespace TRN4CPP
{
	...
	void TRN4CPP_EXPORT  	configure_scheduler_snippets(const unsigned int &id, const unsigned long &seed, const unsigned int &snippets_size, const unsigned int &time_budget,  const std::string &tag = TRN4CPP::DEFAULT_TAG);
