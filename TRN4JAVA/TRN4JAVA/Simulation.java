...
public class					Simulation
{
	...
	public static abstract class	Scheduler
	{
		...
		public static class			Custom
		{
			public static native void	configure(final long id, final long seed, final Scheduler scheduler, final String tag);
		}
		...
		public static abstract class	Mutator
		{
			...
			public static class				Custom
			{
				public static native void	configure(final long id, final long seed, final Mutator mutator);
			}
		}
	}
	...
	public static class	Reservoir
	{
		...
		public static abstract class	Weights
		{
			...
			public static abstract class	Feedforward
			{
				...
				public static class				Custom
				{
					public static native void	configure(final long id, final Weights weights);
				}
			}
	...
	public static class Measurement
	{
		...
		public static class	Readout 
		{
			public static class	Raw
			{
				...
				public static native void	configure(final long id, final long batch_size, final Measurement.Raw raw);
			}
			...
			public static class	MeanSquareError
			{
				...
				public static native void	configure(final long id, final long batch_size, final Measurement.Processed mean_square_error);
			}
			...
			public static class	FrechetDistance
			{
				...
				public static native void	configure(final long id, final long batch_size, final Measurement.Processed frechet_distance);
			}
		}
	...
	public static class					Recording
	{
		public static abstract class	States
		{
			...
			public static native void	configure(final long id, final States states, final boolean train, final boolean prime, final boolean generate);
		}
		...
		public static abstract class	Weights
		{
			...
			public static native void	configure(final long id, final Weights weights, final boolean initialize, final boolean train);
		}
		...
		public static abstract class	Performances
		{
			...
			public static native void	configure(final long id, final Performances performances, final boolean train, final boolean prime, final boolean generate);
		}
		...
		public static abstract class	Scheduling
		{
			...
			public static native void	configure(final long id, final Scheduling scheduling);
		}
	}
}