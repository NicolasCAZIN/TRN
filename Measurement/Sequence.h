...
namespace TRN
{
	...
	{
		class MEASUREMENT_EXPORT Sequence :
			public TRN::Core::Measurement::Abstraction
		{
		public:
			Sequence(const std::shared_ptr<TRN::Core::Measurement::Implementation> &compute, const std::size_t &batch_size);
		...
		public :
			static std::shared_ptr<TRN::Measurement::Sequence> create(const std::shared_ptr<TRN::Core::Measurement::Implementation> &compute, const std::size_t &batch_size);
		};
	};
};
