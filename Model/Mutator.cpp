...
std::shared_ptr<TRN::Core::Mutator> TRN::Model::Mutator::Punch::create(const unsigned long &seed,const float &rate, const std::size_t &size, const std::size_t &number)
{
	return TRN::Mutator::Punch::create(seed, rate, size, number);
}
