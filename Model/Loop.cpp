...
{
	return TRN::Loop::SpatialFilter::create(driver, batch_size, stimulus_size, predicted_position, estimated_position, predicted_stimulus, perceived_stimulus, decoder, tag);
}
