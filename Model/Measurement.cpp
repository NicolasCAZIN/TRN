...
std::shared_ptr<TRN::Core::Measurement::Implementation> MODEL_EXPORT TRN::Model::Measurement::MeanSquareError::create(const std::shared_ptr<TRN::Backend::Driver> &driver, const std::function<void(const std::vector<float> &values, const std::size_t &rows, const  std::size_t &cols)> &functor)
{
	return TRN::Measurement::MeanSquareError::create(driver, functor);
}

std::shared_ptr<TRN::Core::Measurement::Implementation> MODEL_EXPORT TRN::Model::Measurement::FrechetDistance::create(const std::shared_ptr<TRN::Backend::Driver> &driver, const std::function<void(const std::vector<float> &values, const std::size_t &rows, const  std::size_t &cols)> &functor)
{
