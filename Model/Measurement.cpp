...
std::shared_ptr<TRN::Core::Measurement::Implementation> MODEL_EXPORT TRN::Model::Measurement::MeanSquareError::create(const std::shared_ptr<TRN::Backend::Driver> &driver, const std::function<void(const std::size_t &trial, const std::size_t &evaluation, const std::vector<float> &values, const std::size_t &rows, const  std::size_t &cols)> &functor)
{
	return TRN::Measurement::MeanSquareError::create(driver, functor);
}

std::shared_ptr<TRN::Core::Measurement::Implementation> MODEL_EXPORT TRN::Model::Measurement::FrechetDistance::create(const std::shared_ptr<TRN::Backend::Driver> &driver, const std::function<void(const std::size_t &trial, const std::size_t &evaluation, const std::vector<float> &values, const std::size_t &rows, const  std::size_t &cols)> &functor)
{
	return TRN::Measurement::FrechetDistance::create(driver, functor);
}

std::shared_ptr<TRN::Core::Measurement::Implementation> MODEL_EXPORT TRN::Model::Measurement::Custom::create(const std::shared_ptr<TRN::Backend::Driver> &driver, const std::function<void(const std::size_t &trial, const std::size_t &evaluation, const std::vector<float> &primed, const std::vector<float> &predicted, const std::vector<float> &expected, const std::size_t &preamble, const std::size_t &pages, const std::size_t &rows, const  std::size_t &cols)> &functor)
{
